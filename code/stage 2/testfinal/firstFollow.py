...
publishFirstRHS('1firstRules.txt', ENUM_ID, rules, terminals, nonterminals)
publishFirstNT('1firstNT.txt', ENUM_ID, rules, terminals, nonterminals)
publishFollowNT('1followNT.txt', ENUM_ID, rules, terminals, nonterminals)
convertGrammarToIntStream('1grammarFile.txt', rules, ENUM_ID, terminals, nonterminals)
